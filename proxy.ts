...
// runtime the old middleware.ts convention used by default (breaks
// Webpack/Turbopack alike: "node:crypto ... Unhandled scheme"). The `proxy`
// convention (Next.js 16+) always runs on the Node.js runtime, so no
// `runtime` override belongs here any more — declaring one is a build error.
export const config = {
  matcher: [
