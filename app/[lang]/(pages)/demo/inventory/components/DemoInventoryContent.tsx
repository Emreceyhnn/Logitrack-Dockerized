 ...
 * backed by the fixed demo dataset. The header is DemoInventoryHeader (no
 * useWarehouses fetch). Add/Edit/Delete/details all just show a "disabled in
 * demo" toast; no dialog is ever mounted.
 */
